                ...
                <div class="col-xs-12">
                    <div class="box box-purple">
                        <div class="box-header">
                            <button type="button" class="pull-right margin-r-5 btn btn-primary" data-toggle="modal" data-target="#divAddGroup" v-on:click="groupModel={};"><i class="fa fa-plus"></i> 新增</button>
